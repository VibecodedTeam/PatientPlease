  ...
  return (
    <div className={outerClassName} {...rest}>
      <button
        ...
        aria-label="Otwórz sprawdzian znamienia – zasada ABCDE"
        onClick={openBoard}
      >
      ...
      {isExpanded && (
        // overlay-portal: powiększona tablica ABCDE musi renderować się nad resztą
        // strony (żeby dało się ją swobodnie przeciągać do dowolnego rogu), ale jako
        // nieblokująca, pływająca warstwa - reszta strony ma zostać widoczna i
        // interaktywna, w przeciwieństwie do modali w MelanomaImagePopup/Wall
        <OverlayPortal onDismiss={closeBoard} overlayClassName={styles.floatingLayer} dismissOnBackdropClick={false}>
          <div
            ...
            role="dialog"
            aria-label="Sprawdzian znamienia – zasada ABCDE"
