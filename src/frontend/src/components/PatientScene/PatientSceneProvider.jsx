...
export const PatientSceneContext = createContext(undefined);
 ...
 * exposing the result to descendants via usePatientScene().
 * @param {{ url: string, children: React.ReactNode }} props
 */
export function PatientSceneProvider({ url, children }) {
  ...
  return <PatientSceneContext.Provider value={state}>{children}</PatientSceneContext.Provider>;
}

PatientSceneProvider.propTypes = {
