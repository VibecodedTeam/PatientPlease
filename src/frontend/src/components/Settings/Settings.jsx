...
const CONFIRM_MESSAGES = {
  day: 'Powrót do początku dnia? Twój dzisiejszy postęp zostanie utracony.',
  game: 'Powrót do początku gry? Cały postęp zostanie utracony.',
};
    ...
    <>
      ...
      <OverlayPortal>
        <div className={styles.panel}>
          ...
          <span className={styles.kicker}>Kontrola Zmiany Nocnej</span>
          <h2 className={styles.title}>Ustawienia</h2>
          {autoPaused && (
            <p className={styles.notice}>Gra została wstrzymana, ponieważ opuszczono kartę przeglądarki.</p>
          )}
