...
describe('Settings', () => {
  ...
  it('confirming "Back to start of day" resets the day and closes Settings', async () => {
    ...
    expect(
      screen.getByText('Wrócić do początku dnia? Dzisiejszy postęp zostanie utracony.'),
    ).toBeInTheDocument();
  ...
  it('confirming "Back to start of game" resets the game and closes Settings', async () => {
    ...
    expect(
      screen.getByText('Wrócić do początku gry? Cały postęp zostanie utracony.'),
    ).toBeInTheDocument();
  ...
  it('cancelling a reset confirmation keeps Settings open without resetting', async () => {
    ...
    expect(screen.queryByText('Wrócić do początku gry? Cały postęp zostanie utracony.')).not.toBeInTheDocument();
