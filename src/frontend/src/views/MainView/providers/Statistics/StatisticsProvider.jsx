...
import { derivePlaceholderMoneyBreakdown } from './internal/derivePlaceholderMoneyBreakdown';
 ...
 * Statistics popup with the returned dayLog plus a placeholder money-made/
 * money-lost breakdown (see internal/derivePlaceholderMoneyBreakdown).
 */
  ...
  useEffect(() => {
    ...
    endDay()
      .then(({ dayLog }) => {
        ...
        const { moneyMade, moneyLost } = derivePlaceholderMoneyBreakdown(
          dayLog.startingMoney,
          dayLog.endingMoney,
        );
        setStatistics({ ...dayLog, moneyMade, moneyLost });
      })
      .catch((error) => {
